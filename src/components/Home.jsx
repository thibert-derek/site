...
const Home = () => {
  return (
    <div name='home' className='w-full h-screen'>
        <div className = 'max-w-[1000px] mx-auto md:items-center pb-10 flex flex-col justify-center h-full'>
            {/* <div className="py-10">
            ...
            <h2 className ='text-4xl md:text-5xl py-2'>Software Developer</h2>
