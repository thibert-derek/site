...
import Face from '../assets/updatedface2.jpg'
  ...
  return (
    <div name='home' className='w-full h-full md:h-screen'>
      <div className='max-w-[1000px] mx-auto items-center pb-10 flex flex-col justify-center h-full'>
        <div className="py-10">
          <img className="rounded-lg border-2 left-0 max-w-[150px] justify-center items-center md:items-center md:max-w-[225px]" src={Face} />
        </div>
